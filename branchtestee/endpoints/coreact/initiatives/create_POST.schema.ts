...
export const postCoreactInitiativesCreate = async (body: InputType, init?: RequestInit): Promise<OutputType> => {
  const validatedInput = schema.parse(body);
  const result = await fetch(`/_api/coreact/initiatives/create`, {
    method: "POST",

...
// Helper para filtrar props do Figma que não devem ser passadas ao DOM
...
function ContextMenu({
  ...
  return <ContextMenuPrimitive.Root data-slot="context-menu" {...filterFigmaProps(props)} />;
}
...
function ContextMenuTrigger({
  ...
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...filterFigmaProps(props)} />
  );
}
...
function ContextMenuGroup({
  ...
  return (
    <ContextMenuPrimitive.Group data-slot="context-menu-group" {...filterFigmaProps(props)} />
  );
}
...
function ContextMenuPortal({
  ...
  return (
    <ContextMenuPrimitive.Portal data-slot="context-menu-portal" {...filterFigmaProps(props)} />
  );
}
...
function ContextMenuSub({
  ...
  return <ContextMenuPrimitive.Sub data-slot="context-menu-sub" {...filterFigmaProps(props)} />;
}
